...
- **happy-coder** - Claude Code 移动控制工具

---

## 🌟 核心技能

### 1. Happy - Claude Code 移动控制 ⭐⭐⭐⭐⭐

**工具**: `happy-coder` (NPM全局安装)

**功能**:
- ✅ 移动端控制 Claude Code 会话
- ✅ 支持 Codex 模式
- ✅ 支持 Gemini 模式 (ACP)
- ✅ 推送通知功能
- ✅ 后台服务管理
